...
def compare_records(
    ...
    _, (rui_coordinate_1, rui_coordinate_2), _ = rui_record
    return azara_coordinate == rui_coordinate_1 + rui_coordinate_2
...
def clean_up(
    ...
    return "".join(
        ...
        for treasure, _coordinate, location, coordinate, quadrant in combined_record_group
    )
