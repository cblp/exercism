...
complex_t c_div(complex_t a, complex_t b) {
    double const d = b.real * b.real + b.imag * b.imag;
    return (complex_t){.real = (a.real * b.real + a.imag * b.imag) / d,
...
complex_t c_exp(complex_t x) {
    double const f = exp(x.real);
    return (complex_t){.real = f * cos(x.imag), .imag = f * sin(x.imag)};
}
