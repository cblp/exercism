...
data AlgoState = AlgoState {_visited :: Set (Int, Int), _queue :: Seq TaskState}
    deriving (Show)
...
initialAlgoState = AlgoState{_visited = Set.empty, _queue = Seq.empty}
