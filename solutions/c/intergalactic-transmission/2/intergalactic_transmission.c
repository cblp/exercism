    ...
    for (int i = 0; i < in_len; i++) {
        ...
        switch (m) {
            case 0:
                ...
                continue;
            case 1:
                out[out_ix++] = (bitbuf & 0xFE00) >> 8 | (bitbuf & 0x80) >> 7;
                expecting_more = bitbuf & 0x3E;
                break;
            case 2:
                out[out_ix++] = (bitbuf & 0x7E00) >> 7 | (bitbuf & 0xC0) >> 6;
                expecting_more = bitbuf & 0x3E;
                break;
            case 3:
                out[out_ix++] = (bitbuf & 0x3E00) >> 6 | (bitbuf & 0xE0) >> 5;
                expecting_more = bitbuf & 0x1E;
                break;
            case 4:
                out[out_ix++] = (bitbuf & 0x1E00) >> 5 | (bitbuf & 0xF0) >> 4;
                expecting_more = bitbuf & 0x0E;
                break;
            case 5:
                out[out_ix++] = (bitbuf & 0x0E00) >> 4 | (bitbuf & 0xF8) >> 3;
                expecting_more = bitbuf & 0x06;
                break;
            case 6:
                out[out_ix++] = (bitbuf & 0x0600) >> 3 | (bitbuf & 0xFC) >> 2;
                expecting_more = bitbuf & 0x02;
                break;
            case 7:
                out[out_ix++] = (bitbuf & 0x0200) >> 2 | (bitbuf & 0xFE) >> 1;
